...
var DSIDatatables = function () {
    var _initUsersListDatatable = function () {
        ...
        var oTable = table.DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": Routing.generate('usuario_ajax_listado', {'from': 'dsi'}),
                "type": "POST"
            },
...
//                "stateSave": true,
        ...
        tableColumnToggler.css("min-height", "600px");
    ...
    var _initQuestionsListDatatable = function () {
        ...
        var oTable = table.dataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": Routing.generate('dsi_ajax_listado'),
                "type": "POST"
            },
        ...
        $tr.each(function () {
            ...
            if (aData != null) {
                ...
                $btnEditar.click(function () {
                    ...
                    $('#formDSI_id').val($(this).attr('data-id'));
                    $('#formDSI_pregunta').val($(this).attr('data-pregunta'));
                    $('#formDSI_respuesta').val($(this).attr('data-respuesta'));
                    $('#formDSI_usuario').val($(this).attr('data-usuario'));
                    ...
                    for (var li = 0; li < document.getElementById("formDSI_viaSolicitud").childNodes.length; li = li + 1) {
                        var opt = document.getElementById("formDSI_viaSolicitud").childNodes[li];
                    ...
                    if (fuentes.length > 0 && fuentes[0] != "")
                        for (var i = 1; i < fuentes.length + 1; i++) {
                            ...
                            var id = "formDSI_fuentesInfo_" + i + "_id";
                            ...
                            $('#' + "formDSI_fuentesInfo_" + i + "_id").select2({
                                allowClear: true,
                ...
                $btnEliminar.click(function () {
                    ...
                    $('#eliminar').attr('href', Routing.generate('dsi_eliminar_solicitud', {id: id}));
