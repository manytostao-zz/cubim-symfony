...
var UsuarioDatatables = function () {
    ...
    var _initUsersListDatatable = function () {
        ...
        var oTable = table.DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": Routing.generate('usuario_ajax_listado', {'from': 'registro'}),
                "type": "POST"
            },
            "drawCallback": function (settings) {
                table.find('tbody tr').each(function () {
                    ...
                    if (aData != null) {
                        var editarRoute = Routing.generate('usuario_editar', {
                            'id': "PLACEHOLDER",
                            'modulo': "usuario"
                        });
                        var detallesRoute = Routing.generate('usuario_detalles', {
                            'id': "PLACEHOLDER",
                            'modulo': "usuario"
                        });
                        var eliminarRoute = Routing.generate('usuario_eliminar', {
                            'id': "PLACEHOLDER",
                            'modulo': "usuario"
                        });
                        var activarRoute = Routing.generate('usuario_activar', {
                            'id': "PLACEHOLDER",
                            'modulo': "usuario"
                        });
                        var editarRoute = editarRoute.replace("PLACEHOLDER", aData[0]);
                        var detallesRoute = detallesRoute.replace("PLACEHOLDER", aData[0]);
                        var eliminarRoute = eliminarRoute.replace("PLACEHOLDER", aData[0]);
                        var activarRoute = activarRoute.replace("PLACEHOLDER", aData[0]);
                        ...
                        if (aData[23] == true) {
                            nCloneTd.innerHTML = '' +
                                ...
                                '<a title="Editar" href="' + editarRoute + '">' +
                                '<div class="btn blue-hoki btn-small">' +
                                '<i class="fa fa-edit"></i>' +
                                '</div>' +
                                '</a>' +
                                '<a title="Detalles" href="' + detallesRoute + '">' +
                                '<div class="btn blue-hoki btn-small">' +
                                '<i class="fa fa-search"></i>' +
                                '</div>' +
                                '</a>' +
                                '<a title="Eliminar" href="#delete" data-toggle="modal" onclick="document.getElementById(\'eliminar\').href = \'' + eliminarRoute + '\'">' +
                                '<div class="btn blue-hoki btn-small">' +
                                '<i class="fa fa-times"></i>' +
                                '</div>' +
                                '</a>' +
                                '</div>';
                            aData[23] = '<i class="fa fa-check fa-success"></i>';
                        } else {
                            nCloneTd.innerHTML = '' +
                                ...
                                '</div>' +
                                '</a>' +
                                '<a title="Activar" href="#activate" data-toggle="modal" onclick="document.getElementById(\'activar\').href = \'' + activarRoute + '\'">' +
                                '<div class="btn blue-hoki btn-small">' +
                            ...
                            aData[23] = '<i class="fa fa-ban fa-danger"></i>';
                        }
